...
import { getRtspStreamById } from 'apiSdk/rtsp-streams';
import { RtspStreamInterface } from 'interfaces/rtsp-stream';

function RtspStreamViewPage() {
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Stream Url" text={data?.stream_url} />
