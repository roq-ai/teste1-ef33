...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'rtsp_stream.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('rtsp_stream', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'rtsp_stream',
          header: 'Rtsp Stream',
          accessorKey: 'rtsp_stream',
          cell: ({ row: { original: record } }: any) => record?._count?.rtsp_stream,
        }
      : null,
